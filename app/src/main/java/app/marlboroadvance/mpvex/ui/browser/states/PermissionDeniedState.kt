            ...
            Text(
              text = if (isPlayStoreBuild) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                  stringResource(R.string.permission_requires_photos_videos)
                } else {
                  stringResource(R.string.permission_requires_storage)
                }
              } else {
                stringResource(R.string.permission_requires_all_files_access)
              },
      ...
      text = {
        Column(
          ...
          if (isPlayStoreBuild) {
            ...
            Text(
              text = stringResource(R.string.permission_core_functionality),
              style = MaterialTheme.typography.bodyMedium,
            ...
            Text(
              text = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                stringResource(R.string.permission_android13_reading_videos)
              } else {
                stringResource(R.string.permission_reads_media_files)
              },
              style = MaterialTheme.typography.bodyMedium,
              color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
            ...
            Text(
              text = stringResource(R.string.permission_usage_list),
              style = MaterialTheme.typography.bodyMedium,
              color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
          } else {
            ...
            Text(
              text = stringResource(R.string.permission_always_required),
              style = MaterialTheme.typography.bodyMedium,
              color = MaterialTheme.colorScheme.onSurfaceVariant,
            )

            Text(
              text = stringResource(R.string.permission_android11_security),
              style = MaterialTheme.typography.bodyMedium,
              color = MaterialTheme.colorScheme.onSurfaceVariant,
            )

            Text(
              text = stringResource(R.string.permission_auto_discovery_only),
              style = MaterialTheme.typography.bodyMedium,
              color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
          }
          ...
          Text(
            text = stringResource(R.string.permission_open_source),
            style = MaterialTheme.typography.bodyMedium,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
          )
